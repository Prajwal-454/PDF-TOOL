...
export const TOOLS: Tool[] = [
  ...
  { slug: "images-to-pdf", name: "JPG/PNG → PDF", desc: "Scan images into a PDF. Phone photos (WEBP/HEIC/GIF/BMP/TIFF) auto-convert.", category: "Convert to PDF", accept: ".jpg,.jpeg,.png,.webp,.heic,.heif,.gif,.bmp,.tif,.tiff,.avif", multi: true, anyUpload: true, fields: [] },
  ...
  { slug: "sign", name: "E-sign", desc: "Place a PNG signature image.", category: "Security", accept: "application/pdf", fields: [{ key: "page", label: "Page", type: "number", placeholder: "1" }, { key: "x", label: "X (pt from left)", type: "number", placeholder: "100", defaultValue: "100" }, { key: "y", label: "Y (pt from top)", type: "number", placeholder: "100", defaultValue: "100" }], hint: "Upload PDF below, then upload signature PNG when prompted. Image-of-signature now; PAdES certs later." },
