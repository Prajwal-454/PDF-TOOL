...
export const TOOLS: Tool[] = [
  ...
  { slug: "images-to-pdf", name: "JPG/PNG → PDF", desc: "Scan images into a PDF.", category: "Convert to PDF", accept: "image/*", multi: true, anyUpload: true, fields: [] },
  { slug: "office-to-pdf", name: "Office → PDF", desc: "DOCX/XLSX/PPTX/HTML/TXT → PDF. Free engine; LibreOffice used if installed.", category: "Convert to PDF", accept: ".docx,.xlsx,.pptx,.html,.txt", anyUpload: true, fields: [{ key: "kind", label: "Input type", type: "select", options: [{ value: "docx", label: "Word (.docx)" }, { value: "xlsx", label: "Excel (.xlsx)" }, { value: "pptx", label: "PowerPoint (.pptx)" }, { value: "html", label: "HTML" }, { value: "txt", label: "Text" }], defaultValue: "docx" }] },
